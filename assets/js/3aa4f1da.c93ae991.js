...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "ENTERED": () => (/* binding */ ENTERED),
  "ENTERING": () => (/* binding */ ENTERING),
  "EXITED": () => (/* binding */ EXITED),
  "EXITING": () => (/* binding */ EXITING),
  "UNMOUNTED": () => (/* binding */ UNMOUNTED),
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7294);
const _excluded = ["children", "arrowProps", "popper", "show"];
...
const Tooltip = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.forwardRef((_ref, ref) => {
  let {
    children,
    arrowProps,
    popper
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", _extends({
    ...
    className: (0,clsx__WEBPACK_IMPORTED_MODULE_1__.default)(props.className, 'absolute')
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", _extends({}, arrowProps, {
    style: arrowProps.style,
    className: (0,clsx__WEBPACK_IMPORTED_MODULE_1__.default)('absolute w-3 h-3 z-[-1]', 'before:absolute before:rotate-45 before:bg-black before:top-0 before:left-0 before:w-3 before:h-3', popper.placement === 'left' && '-right-1', popper.placement === 'right' && '-left-1', popper.placement === 'bottom' && '-top-1', popper.placement === 'top' && '-bottom-1')
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    className: "py-1 px-2 text-center rounded bg-black text-white "
  }, children));
});
...
const frontMatter={};const contentTitle=undefined;const metadata={"unversionedId":"Overlay","id":"Overlay","isDocsHomePage":false,"title":"Overlay","description":"A flexible base component for building tooltips, popups, and any other floating UI components.","source":"@site/docs/Overlay.mdx","sourceDirName":".","slug":"/Overlay","permalink":"/ui/Overlay","version":"current","frontMatter":{},"sidebar":"docs","previous":{"title":"Navs and tabs","permalink":"/ui/Nav"},"next":{"title":"Portal","permalink":"/ui/Portal"}};/* @jsxRuntime classic */ /* @jsx mdx */const toc=[{value:'Creating an Overlay',id:'creating-an-overlay',children:[]},{value:'Animations',id:'animations',children:[]}];const layoutProps={toc};const MDXLayout="wrapper";function MDXContent({components,...props}){return (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_2__/* .mdx */ .kt)(MDXLayout,(0,_Users_jquense_src_ui_www_node_modules_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_4__/* .default */ .Z)({},layoutProps,props,{components:components,mdxType:"MDXLayout"}),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_2__/* .mdx */ .kt)("p",null,`A flexible base component for building tooltips, popups, and any other floating UI components.
`,(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_2__/* .mdx */ .kt)("inlineCode",{parentName:"p"},`Overlay`),` combines `,(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_2__/* .mdx */ .kt)("a",{parentName:"p","href":"https://popper.js.org/"},`Popper`),`, click-to-dismiss, and optional transitions for
rendering floating UI relative to another element.`),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_2__/* .mdx */ .kt)("h2",{"id":"creating-an-overlay"},`Creating an Overlay`),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_2__/* .mdx */ .kt)("p",null,`Overlays consist of at least two elements, the "overlay", the element to be positioned,
...
positioning engine.`),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_2__/* .mdx */ .kt)(_theme_ImportContext__WEBPACK_IMPORTED_MODULE_3__.default,{imports:()=>(0,_theme_ImportContext__WEBPACK_IMPORTED_MODULE_3__.allValues)({"clsx":Promise.resolve().then(()=>(0,_Users_jquense_src_ui_www_node_modules_babel_runtime_helpers_esm_interopRequireWildcard__WEBPACK_IMPORTED_MODULE_0__/* .default */ .Z)(__webpack_require__(6010))),"@restart/ui":Promise.resolve().then(()=>(0,_Users_jquense_src_ui_www_node_modules_babel_runtime_helpers_esm_interopRequireWildcard__WEBPACK_IMPORTED_MODULE_0__/* .default */ .Z)(__webpack_require__(6352))),"../src/Button":Promise.resolve().then(()=>(0,_Users_jquense_src_ui_www_node_modules_babel_runtime_helpers_esm_interopRequireWildcard__WEBPACK_IMPORTED_MODULE_0__/* .default */ .Z)(__webpack_require__(5733)))}),mdxType:"ImportContext"},(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_2__/* .mdx */ .kt)("pre",null,(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_2__/* .mdx */ .kt)("code",{parentName:"pre","className":"language-jsx","metastring":"live editor=collapse","live":true,"editor":"collapse"},`import clsx from "clsx";
...
<OverlayExample />;
`))),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_2__/* .mdx */ .kt)("h2",{"id":"animations"},`Animations`),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_2__/* .mdx */ .kt)("p",null,`Overlays support `,(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_2__/* .mdx */ .kt)("inlineCode",{parentName:"p"},`react-transition-group`),` compliant Transition components (though you are welcome to use something else).`),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_2__/* .mdx */ .kt)(_theme_ImportContext__WEBPACK_IMPORTED_MODULE_3__.default,{imports:()=>(0,_theme_ImportContext__WEBPACK_IMPORTED_MODULE_3__.allValues)({"react-transition-group/Transition":Promise.resolve().then(()=>(0,_Users_jquense_src_ui_www_node_modules_babel_runtime_helpers_esm_interopRequireWildcard__WEBPACK_IMPORTED_MODULE_0__/* .default */ .Z)(__webpack_require__(2745))),"clsx":Promise.resolve().then(()=>(0,_Users_jquense_src_ui_www_node_modules_babel_runtime_helpers_esm_interopRequireWildcard__WEBPACK_IMPORTED_MODULE_0__/* .default */ .Z)(__webpack_require__(6010))),"@restart/ui":Promise.resolve().then(()=>(0,_Users_jquense_src_ui_www_node_modules_babel_runtime_helpers_esm_interopRequireWildcard__WEBPACK_IMPORTED_MODULE_0__/* .default */ .Z)(__webpack_require__(6352))),"../src/Tooltip":Promise.resolve().then(()=>(0,_Users_jquense_src_ui_www_node_modules_babel_runtime_helpers_esm_interopRequireWildcard__WEBPACK_IMPORTED_MODULE_0__/* .default */ .Z)(__webpack_require__(2720)))}),mdxType:"ImportContext"},(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_2__/* .mdx */ .kt)("pre",null,(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_2__/* .mdx */ .kt)("code",{parentName:"pre","className":"language-jsx","metastring":"live","live":true},`import Transition from "react-transition-group/Transition";
